...
% figure is drawn
tmpfilename = 'figReff_sens2_mmwr';
...
ylabel('Testing frequency, days','fontsize',18,'verticalalignment','bottom','interpreter','latex');
 title({'Outbreak size, 15,000 individuals, 90\% sensitivity';'no entry testing'},'fontsize',18,'interpreter','latex')
