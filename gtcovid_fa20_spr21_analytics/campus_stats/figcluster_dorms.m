...
% main data goes here
[num,txt,raw]=xlsread('gt_dorm_cases_clusters.xlsx');
tmph=bar(2:length(txt),num(:,3:4)*100);
set(gca,'xtick',2:length(txt));
set(gca,'xticklabel',txt(2:end));
...
% legend
% tmplh = legend('stuff',...);
tmplh = legend('Cluster rate','Positivity rate');
% remove box
% set(tmplh,'visible','off')
legend('boxoff');
set(tmplh,'Location','NorthEast');

xlabel('','fontsize',20,'verticalalignment','top','interpreter','latex');
ylabel('Percent','fontsize',20,'verticalalignment','bottom','interpreter','latex');
% title('','fontsize',24)
